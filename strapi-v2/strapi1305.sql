...
DROP SEQUENCE IF EXISTS about_uses_id_seq;
...
DROP SEQUENCE IF EXISTS about_uses_components_id_seq;
...
DROP TABLE IF EXISTS "about_uses_page_links";
DROP SEQUENCE IF EXISTS about_uses_page_links_id_seq;
...
DROP SEQUENCE IF EXISTS admin_permissions_id_seq;
...
DROP SEQUENCE IF EXISTS admin_permissions_role_links_id_seq;
...
DROP SEQUENCE IF EXISTS admin_roles_id_seq;
...
DROP SEQUENCE IF EXISTS admin_users_roles_links_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_accordions";
DROP SEQUENCE IF EXISTS components_c4d_components_accordions_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_accordions_components";
DROP SEQUENCE IF EXISTS components_c4d_components_accordions_components_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_carousel_paragraph_icons";
DROP SEQUENCE IF EXISTS components_c4d_components_carousel_paragraph_icons_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_carousel_paragraph_icons_components";
DROP SEQUENCE IF EXISTS components_c4d_components_carousel_paragraph_icons_compo_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_carousel_slide_job_offres";
DROP SEQUENCE IF EXISTS components_c4d_components_carousel_slide_job_offres_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_carousel_slides";
DROP SEQUENCE IF EXISTS components_c4d_components_carousel_slides_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_carousel_slides_components";
DROP SEQUENCE IF EXISTS components_c4d_components_carousel_slides_components_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_carousel_type_linears";
DROP SEQUENCE IF EXISTS components_c4d_components_carousel_type_linears_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_contact_forms";
DROP SEQUENCE IF EXISTS components_c4d_components_contact_forms_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_contact_forms_components";
DROP SEQUENCE IF EXISTS components_c4d_components_contact_forms_components_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_contact_job_forms";
DROP SEQUENCE IF EXISTS components_c4d_components_contact_job_forms_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_ellipses";
DROP SEQUENCE IF EXISTS components_c4d_components_ellipses_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_footers";
DROP SEQUENCE IF EXISTS components_c4d_components_footers_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_paragraphs";
DROP SEQUENCE IF EXISTS components_c4d_components_paragraphs_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_slider_profile_cards";
DROP SEQUENCE IF EXISTS components_c4d_components_slider_profile_cards_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_slider_profile_cards_components";
DROP SEQUENCE IF EXISTS components_c4d_components_slider_profile_cards_component_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_components_spontaneous_job_application_forms";
DROP SEQUENCE IF EXISTS components_c4d_components_spontaneous_job_application_fo_id_seq;
...
(1,	'#ffffff',	'#000000',	't',	'AUCUN POSTE CORRESPOND À VOTRE PROFILE ?',	'#ffffff',	't',	'Nous cherchons toujours des talents passionnés.  N''hésitez pas à nous envoyer votre candidature spontanée <br><br> Notre équipe examine chaque candidature  et vous répondra sous 48 heures',	'#ffffff',	't',	'envoyer',	NULL,	'#ffffff',	'#1E2634',	'#ffffff',	'#F28705',	'Envoyer',	'#F28705',	'#ffffff',	'#F28705',	NULL,	NULL,	'Formulaire de contact envoyé avec succes, un expert vous contacteras dans un delai de 48h.',	NULL,	NULL);

DROP TABLE IF EXISTS "components_c4d_components_vertical_spaces";
DROP SEQUENCE IF EXISTS components_c4d_components_vertical_spaces_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_items_accordions_items";
DROP SEQUENCE IF EXISTS components_c4d_items_accordions_items_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_items_contact_form_items";
DROP SEQUENCE IF EXISTS components_c4d_items_contact_form_items_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_items_footer_column_items";
DROP SEQUENCE IF EXISTS components_c4d_items_footer_column_items_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_items_footer_social_items";
DROP SEQUENCE IF EXISTS components_c4d_items_footer_social_items_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_items_icons";
DROP SEQUENCE IF EXISTS components_c4d_items_icons_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_items_menu_items";
DROP SEQUENCE IF EXISTS components_c4d_items_menu_items_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_items_slider_items";
DROP SEQUENCE IF EXISTS components_c4d_items_slider_items_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_items_slider_profile_items";
DROP SEQUENCE IF EXISTS components_c4d_items_slider_profile_items_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_items_slider_profile_items_components";
DROP SEQUENCE IF EXISTS components_c4d_items_slider_profile_items_components_id_seq;
...
DROP TABLE IF EXISTS "components_c4d_items_slider_profile_social_medias_items";
DROP SEQUENCE IF EXISTS components_c4d_items_slider_profile_social_medias_items_id_seq;
...
DROP SEQUENCE IF EXISTS contact_forms_id_seq;
...
DROP TABLE IF EXISTS "contacts_components";
DROP SEQUENCE IF EXISTS contacts_components_id_seq;
...
DROP TABLE IF EXISTS "contacts_page_links";
DROP SEQUENCE IF EXISTS contacts_page_links_id_seq;
...
DROP SEQUENCE IF EXISTS files_folder_links_id_seq;
...
DROP SEQUENCE IF EXISTS files_related_morphs_id_seq;
...
(1547,	31,	4,	'c4d-components.carousel-type-linear',	'image',	1),
...
(1546,	30,	1,	'c4d-components.spontaneous-job-application-form',	'carouselImgSrc',	1);

DROP TABLE IF EXISTS "footers";
DROP SEQUENCE IF EXISTS footers_id_seq;
...
DROP SEQUENCE IF EXISTS footers_components_id_seq;
...
DROP SEQUENCE IF EXISTS home_pages_components_id_seq;
...
DROP TABLE IF EXISTS "home_pages_page_links";
DROP SEQUENCE IF EXISTS home_pages_page_links_id_seq;
...
DROP SEQUENCE IF EXISTS i18n_locale_id_seq;
...
DROP TABLE IF EXISTS "join_uses";
DROP SEQUENCE IF EXISTS join_uses_id_seq;
...
(1,	'2024-06-11 17:07:38.827',	'2025-05-13 13:03:59.942',	'2024-06-11 17:14:10.603',	1,	1);

DROP TABLE IF EXISTS "join_uses_components";
DROP SEQUENCE IF EXISTS join_uses_components_id_seq;
...
(33,	1,	13,	'c4d-components.vertical-space',	'dz',	1),
(34,	1,	4,	'c4d-components.carousel-type-linear',	'dz',	2),
(35,	1,	1,	'c4d-components.spontaneous-job-application-form',	'dz',	3);

DROP TABLE IF EXISTS "join_uses_page_links";
DROP SEQUENCE IF EXISTS join_uses_page_links_id_seq;
...
DROP SEQUENCE IF EXISTS menus_components_id_seq;
...
DROP SEQUENCE IF EXISTS newsletters_id_seq;
...
DROP SEQUENCE IF EXISTS pages_components_id_seq;
...
DROP SEQUENCE IF EXISTS strapi_api_token_permissions_id_seq;
...
DROP SEQUENCE IF EXISTS strapi_api_token_permissions_token_links_id_seq;
...
DROP SEQUENCE IF EXISTS strapi_api_tokens_id_seq;
...
DROP SEQUENCE IF EXISTS strapi_core_store_settings_id_seq;
...
DROP SEQUENCE IF EXISTS strapi_database_schema_id_seq;
...
DROP SEQUENCE IF EXISTS strapi_release_actions_id_seq;
...
DROP SEQUENCE IF EXISTS strapi_release_actions_release_links_id_seq;
...
DROP SEQUENCE IF EXISTS strapi_releases_id_seq;
...
DROP SEQUENCE IF EXISTS strapi_transfer_token_permissions_id_seq;
...
DROP SEQUENCE IF EXISTS strapi_transfer_token_permissions_token_links_id_seq;
...
DROP SEQUENCE IF EXISTS strapi_transfer_tokens_id_seq;
...
DROP SEQUENCE IF EXISTS strapi_webhooks_id_seq;
...
DROP SEQUENCE IF EXISTS up_permissions_id_seq;
...
DROP SEQUENCE IF EXISTS up_permissions_role_links_id_seq;
...
DROP SEQUENCE IF EXISTS up_roles_id_seq;
...
DROP SEQUENCE IF EXISTS up_users_id_seq;
...
DROP SEQUENCE IF EXISTS up_users_role_links_id_seq;
...
DROP SEQUENCE IF EXISTS upload_folders_id_seq;
...
DROP SEQUENCE IF EXISTS upload_folders_parent_links_id_seq;
