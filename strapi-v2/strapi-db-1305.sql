...
(1,	'plugin::content-manager.explorer.create',	'{}',	'plugin::users-permissions.user',	'{"fields": ["username", "email", "provider", "password", "resetPasswordToken", "confirmationToken", "confirmed", "blocked", "role"]}',	'[]',	'2025-05-13 17:03:58.333',	'2025-05-13 17:03:58.333',	NULL,	NULL),
(2,	'plugin::content-manager.explorer.create',	'{}',	'api::about-us.about-us',	'{"fields": ["dz", "page"]}',	'[]',	'2025-05-13 17:03:58.532',	'2025-05-13 17:03:58.532',	NULL,	NULL),
(3,	'plugin::content-manager.explorer.create',	'{}',	'api::contact.contact',	'{"fields": ["dz", "page"]}',	'[]',	'2025-05-13 17:03:58.752',	'2025-05-13 17:03:58.752',	NULL,	NULL),
(4,	'plugin::content-manager.explorer.create',	'{}',	'api::contact-form.contact-form',	'{"fields": ["firstName", "lastName", "email", "phone", "message", "sendCommunication"]}',	'[]',	'2025-05-13 17:03:58.952',	'2025-05-13 17:03:58.952',	NULL,	NULL),
(5,	'plugin::content-manager.explorer.create',	'{}',	'api::footer.footer',	'{"fields": ["backgroundColor", "enableTransparentBackground", "title", "titleColor", "textColor", "copyrightText", "newsletterTitle", "newsletterTitleColor", "fieldPlaceholder", "textPopup", "textColorPopup", "startColumn.text", "startColumn.link", "centerColumn.text", "centerColumn.link", "endColumn.text", "endColumn.link", "legalItems.text", "legalItems.link", "socialMedias.icon", "socialMedias.link"]}',	'[]',	'2025-05-13 17:03:59.152',	'2025-05-13 17:03:59.152',	NULL,	NULL),
(6,	'plugin::content-manager.explorer.create',	'{}',	'api::home-page.home-page',	'{"fields": ["dz", "page"]}',	'[]',	'2025-05-13 17:03:59.352',	'2025-05-13 17:03:59.352',	NULL,	NULL),
(7,	'plugin::content-manager.explorer.create',	'{}',	'api::join-us.join-us',	'{"fields": ["dz", "page"]}',	'[]',	'2025-05-13 17:03:59.552',	'2025-05-13 17:03:59.552',	NULL,	NULL),
(8,	'plugin::content-manager.explorer.create',	'{}',	'api::menu.menu',	'{"fields": ["backgroundColor", "enableTransparentBackground", "separationBarColor", "title", "titleColor", "textColor", "textButton", "linkButton", "menuItems.text", "menuItems.link", "titleLink"]}',	'[]',	'2025-05-13 17:03:59.752',	'2025-05-13 17:03:59.752',	NULL,	NULL),
(9,	'plugin::content-manager.explorer.create',	'{}',	'api::newsletter.newsletter',	'{"fields": ["email"]}',	'[]',	'2025-05-13 17:03:59.952',	'2025-05-13 17:03:59.952',	NULL,	NULL),
(11,	'plugin::content-manager.explorer.read',	'{}',	'plugin::users-permissions.user',	'{"fields": ["username", "email", "provider", "password", "resetPasswordToken", "confirmationToken", "confirmed", "blocked", "role"]}',	'[]',	'2025-05-13 17:04:00.352',	'2025-05-13 17:04:00.352',	NULL,	NULL),
(12,	'plugin::content-manager.explorer.read',	'{}',	'api::about-us.about-us',	'{"fields": ["dz", "page"]}',	'[]',	'2025-05-13 17:04:00.562',	'2025-05-13 17:04:00.562',	NULL,	NULL),
(13,	'plugin::content-manager.explorer.read',	'{}',	'api::contact.contact',	'{"fields": ["dz", "page"]}',	'[]',	'2025-05-13 17:04:00.762',	'2025-05-13 17:04:00.762',	NULL,	NULL),
(14,	'plugin::content-manager.explorer.read',	'{}',	'api::contact-form.contact-form',	'{"fields": ["firstName", "lastName", "email", "phone", "message", "sendCommunication"]}',	'[]',	'2025-05-13 17:04:00.962',	'2025-05-13 17:04:00.962',	NULL,	NULL),
(15,	'plugin::content-manager.explorer.read',	'{}',	'api::footer.footer',	'{"fields": ["backgroundColor", "enableTransparentBackground", "title", "titleColor", "textColor", "copyrightText", "newsletterTitle", "newsletterTitleColor", "fieldPlaceholder", "textPopup", "textColorPopup", "startColumn.text", "startColumn.link", "centerColumn.text", "centerColumn.link", "endColumn.text", "endColumn.link", "legalItems.text", "legalItems.link", "socialMedias.icon", "socialMedias.link"]}',	'[]',	'2025-05-13 17:04:01.162',	'2025-05-13 17:04:01.162',	NULL,	NULL),
(16,	'plugin::content-manager.explorer.read',	'{}',	'api::home-page.home-page',	'{"fields": ["dz", "page"]}',	'[]',	'2025-05-13 17:04:01.362',	'2025-05-13 17:04:01.362',	NULL,	NULL),
(17,	'plugin::content-manager.explorer.read',	'{}',	'api::join-us.join-us',	'{"fields": ["dz", "page"]}',	'[]',	'2025-05-13 17:04:01.572',	'2025-05-13 17:04:01.572',	NULL,	NULL),
(18,	'plugin::content-manager.explorer.read',	'{}',	'api::menu.menu',	'{"fields": ["backgroundColor", "enableTransparentBackground", "separationBarColor", "title", "titleColor", "textColor", "textButton", "linkButton", "menuItems.text", "menuItems.link", "titleLink"]}',	'[]',	'2025-05-13 17:04:01.772',	'2025-05-13 17:04:01.772',	NULL,	NULL),
(19,	'plugin::content-manager.explorer.read',	'{}',	'api::newsletter.newsletter',	'{"fields": ["email"]}',	'[]',	'2025-05-13 17:04:01.972',	'2025-05-13 17:04:01.972',	NULL,	NULL),
(21,	'plugin::content-manager.explorer.update',	'{}',	'plugin::users-permissions.user',	'{"fields": ["username", "email", "provider", "password", "resetPasswordToken", "confirmationToken", "confirmed", "blocked", "role"]}',	'[]',	'2025-05-13 17:04:02.372',	'2025-05-13 17:04:02.372',	NULL,	NULL),
(22,	'plugin::content-manager.explorer.update',	'{}',	'api::about-us.about-us',	'{"fields": ["dz", "page"]}',	'[]',	'2025-05-13 17:04:02.572',	'2025-05-13 17:04:02.572',	NULL,	NULL),
(23,	'plugin::content-manager.explorer.update',	'{}',	'api::contact.contact',	'{"fields": ["dz", "page"]}',	'[]',	'2025-05-13 17:04:02.772',	'2025-05-13 17:04:02.772',	NULL,	NULL),
(24,	'plugin::content-manager.explorer.update',	'{}',	'api::contact-form.contact-form',	'{"fields": ["firstName", "lastName", "email", "phone", "message", "sendCommunication"]}',	'[]',	'2025-05-13 17:04:02.972',	'2025-05-13 17:04:02.972',	NULL,	NULL),
(25,	'plugin::content-manager.explorer.update',	'{}',	'api::footer.footer',	'{"fields": ["backgroundColor", "enableTransparentBackground", "title", "titleColor", "textColor", "copyrightText", "newsletterTitle", "newsletterTitleColor", "fieldPlaceholder", "textPopup", "textColorPopup", "startColumn.text", "startColumn.link", "centerColumn.text", "centerColumn.link", "endColumn.text", "endColumn.link", "legalItems.text", "legalItems.link", "socialMedias.icon", "socialMedias.link"]}',	'[]',	'2025-05-13 17:04:03.172',	'2025-05-13 17:04:03.172',	NULL,	NULL),
(26,	'plugin::content-manager.explorer.update',	'{}',	'api::home-page.home-page',	'{"fields": ["dz", "page"]}',	'[]',	'2025-05-13 17:04:03.372',	'2025-05-13 17:04:03.372',	NULL,	NULL),
(27,	'plugin::content-manager.explorer.update',	'{}',	'api::join-us.join-us',	'{"fields": ["dz", "page"]}',	'[]',	'2025-05-13 17:04:03.572',	'2025-05-13 17:04:03.572',	NULL,	NULL),
(90,	'admin::api-tokens.create',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:16.361',	'2025-05-13 17:04:16.361',	NULL,	NULL),
(91,	'admin::api-tokens.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:16.561',	'2025-05-13 17:04:16.561',	NULL,	NULL),
(28,	'plugin::content-manager.explorer.update',	'{}',	'api::menu.menu',	'{"fields": ["backgroundColor", "enableTransparentBackground", "separationBarColor", "title", "titleColor", "textColor", "textButton", "linkButton", "menuItems.text", "menuItems.link", "titleLink"]}',	'[]',	'2025-05-13 17:04:03.772',	'2025-05-13 17:04:03.772',	NULL,	NULL),
(29,	'plugin::content-manager.explorer.update',	'{}',	'api::newsletter.newsletter',	'{"fields": ["email"]}',	'[]',	'2025-05-13 17:04:03.972',	'2025-05-13 17:04:03.972',	NULL,	NULL),
(31,	'plugin::content-manager.explorer.delete',	'{}',	'plugin::users-permissions.user',	'{}',	'[]',	'2025-05-13 17:04:04.382',	'2025-05-13 17:04:04.382',	NULL,	NULL),
(32,	'plugin::content-manager.explorer.delete',	'{}',	'api::about-us.about-us',	'{}',	'[]',	'2025-05-13 17:04:04.582',	'2025-05-13 17:04:04.582',	NULL,	NULL),
(33,	'plugin::content-manager.explorer.delete',	'{}',	'api::contact.contact',	'{}',	'[]',	'2025-05-13 17:04:04.782',	'2025-05-13 17:04:04.782',	NULL,	NULL),
(34,	'plugin::content-manager.explorer.delete',	'{}',	'api::contact-form.contact-form',	'{}',	'[]',	'2025-05-13 17:04:04.982',	'2025-05-13 17:04:04.982',	NULL,	NULL),
(35,	'plugin::content-manager.explorer.delete',	'{}',	'api::footer.footer',	'{}',	'[]',	'2025-05-13 17:04:05.192',	'2025-05-13 17:04:05.192',	NULL,	NULL),
(36,	'plugin::content-manager.explorer.delete',	'{}',	'api::home-page.home-page',	'{}',	'[]',	'2025-05-13 17:04:05.402',	'2025-05-13 17:04:05.402',	NULL,	NULL),
(37,	'plugin::content-manager.explorer.delete',	'{}',	'api::join-us.join-us',	'{}',	'[]',	'2025-05-13 17:04:05.602',	'2025-05-13 17:04:05.602',	NULL,	NULL),
(38,	'plugin::content-manager.explorer.delete',	'{}',	'api::menu.menu',	'{}',	'[]',	'2025-05-13 17:04:05.802',	'2025-05-13 17:04:05.802',	NULL,	NULL),
(39,	'plugin::content-manager.explorer.delete',	'{}',	'api::newsletter.newsletter',	'{}',	'[]',	'2025-05-13 17:04:06.012',	'2025-05-13 17:04:06.012',	NULL,	NULL),
(40,	'plugin::content-manager.explorer.delete',	'{}',	'api::page.page',	'{}',	'[]',	'2025-05-13 17:04:06.222',	'2025-05-13 17:04:06.222',	NULL,	NULL),
(41,	'plugin::content-manager.explorer.publish',	'{}',	'api::about-us.about-us',	'{}',	'[]',	'2025-05-13 17:04:06.422',	'2025-05-13 17:04:06.422',	NULL,	NULL),
(42,	'plugin::content-manager.explorer.publish',	'{}',	'api::contact.contact',	'{}',	'[]',	'2025-05-13 17:04:06.632',	'2025-05-13 17:04:06.632',	NULL,	NULL),
(43,	'plugin::content-manager.explorer.publish',	'{}',	'api::contact-form.contact-form',	'{}',	'[]',	'2025-05-13 17:04:06.842',	'2025-05-13 17:04:06.842',	NULL,	NULL),
(44,	'plugin::content-manager.explorer.publish',	'{}',	'api::footer.footer',	'{}',	'[]',	'2025-05-13 17:04:07.042',	'2025-05-13 17:04:07.042',	NULL,	NULL),
(45,	'plugin::content-manager.explorer.publish',	'{}',	'api::home-page.home-page',	'{}',	'[]',	'2025-05-13 17:04:07.242',	'2025-05-13 17:04:07.242',	NULL,	NULL),
(46,	'plugin::content-manager.explorer.publish',	'{}',	'api::join-us.join-us',	'{}',	'[]',	'2025-05-13 17:04:07.442',	'2025-05-13 17:04:07.442',	NULL,	NULL),
(47,	'plugin::content-manager.explorer.publish',	'{}',	'api::menu.menu',	'{}',	'[]',	'2025-05-13 17:04:07.652',	'2025-05-13 17:04:07.652',	NULL,	NULL),
(48,	'plugin::content-manager.explorer.publish',	'{}',	'api::newsletter.newsletter',	'{}',	'[]',	'2025-05-13 17:04:07.852',	'2025-05-13 17:04:07.852',	NULL,	NULL),
(49,	'plugin::content-manager.explorer.publish',	'{}',	'api::page.page',	'{}',	'[]',	'2025-05-13 17:04:08.072',	'2025-05-13 17:04:08.072',	NULL,	NULL),
(50,	'plugin::content-manager.single-types.configure-view',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:08.272',	'2025-05-13 17:04:08.272',	NULL,	NULL),
(51,	'plugin::content-manager.collection-types.configure-view',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:08.472',	'2025-05-13 17:04:08.472',	NULL,	NULL),
(52,	'plugin::content-manager.components.configure-layout',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:08.672',	'2025-05-13 17:04:08.672',	NULL,	NULL),
(53,	'plugin::content-type-builder.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:08.872',	'2025-05-13 17:04:08.872',	NULL,	NULL),
(54,	'plugin::email.settings.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:09.072',	'2025-05-13 17:04:09.072',	NULL,	NULL),
(55,	'plugin::upload.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:09.271',	'2025-05-13 17:04:09.271',	NULL,	NULL),
(56,	'plugin::upload.assets.create',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:09.472',	'2025-05-13 17:04:09.472',	NULL,	NULL),
(57,	'plugin::upload.assets.update',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:09.672',	'2025-05-13 17:04:09.672',	NULL,	NULL),
(58,	'plugin::upload.assets.download',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:09.872',	'2025-05-13 17:04:09.872',	NULL,	NULL),
(59,	'plugin::upload.assets.copy-link',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:10.072',	'2025-05-13 17:04:10.072',	NULL,	NULL),
(60,	'plugin::upload.configure-view',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:10.271',	'2025-05-13 17:04:10.271',	NULL,	NULL),
(61,	'plugin::upload.settings.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:10.472',	'2025-05-13 17:04:10.472',	NULL,	NULL),
(62,	'plugin::i18n.locale.create',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:10.672',	'2025-05-13 17:04:10.672',	NULL,	NULL),
(63,	'plugin::i18n.locale.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:10.872',	'2025-05-13 17:04:10.872',	NULL,	NULL),
(64,	'plugin::i18n.locale.update',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:11.071',	'2025-05-13 17:04:11.071',	NULL,	NULL),
(65,	'plugin::i18n.locale.delete',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:11.271',	'2025-05-13 17:04:11.271',	NULL,	NULL),
(66,	'plugin::users-permissions.roles.create',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:11.471',	'2025-05-13 17:04:11.471',	NULL,	NULL),
(67,	'plugin::users-permissions.roles.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:11.672',	'2025-05-13 17:04:11.672',	NULL,	NULL),
(68,	'plugin::users-permissions.roles.update',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:11.871',	'2025-05-13 17:04:11.871',	NULL,	NULL),
(69,	'plugin::users-permissions.roles.delete',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:12.072',	'2025-05-13 17:04:12.072',	NULL,	NULL),
(70,	'plugin::users-permissions.providers.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:12.272',	'2025-05-13 17:04:12.272',	NULL,	NULL),
(71,	'plugin::users-permissions.providers.update',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:12.507',	'2025-05-13 17:04:12.507',	NULL,	NULL),
(72,	'plugin::users-permissions.email-templates.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:12.722',	'2025-05-13 17:04:12.722',	NULL,	NULL),
(73,	'plugin::users-permissions.email-templates.update',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:12.922',	'2025-05-13 17:04:12.922',	NULL,	NULL),
(74,	'plugin::users-permissions.advanced-settings.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:13.122',	'2025-05-13 17:04:13.122',	NULL,	NULL),
(75,	'plugin::users-permissions.advanced-settings.update',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:13.322',	'2025-05-13 17:04:13.322',	NULL,	NULL),
(76,	'admin::marketplace.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:13.521',	'2025-05-13 17:04:13.521',	NULL,	NULL),
(77,	'admin::webhooks.create',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:13.722',	'2025-05-13 17:04:13.722',	NULL,	NULL),
(78,	'admin::webhooks.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:13.921',	'2025-05-13 17:04:13.921',	NULL,	NULL),
(79,	'admin::webhooks.update',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:14.122',	'2025-05-13 17:04:14.122',	NULL,	NULL),
(80,	'admin::webhooks.delete',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:14.322',	'2025-05-13 17:04:14.322',	NULL,	NULL),
(81,	'admin::users.create',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:14.522',	'2025-05-13 17:04:14.522',	NULL,	NULL),
(82,	'admin::users.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:14.722',	'2025-05-13 17:04:14.722',	NULL,	NULL),
(83,	'admin::users.update',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:14.921',	'2025-05-13 17:04:14.921',	NULL,	NULL),
(84,	'admin::users.delete',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:15.151',	'2025-05-13 17:04:15.151',	NULL,	NULL),
(85,	'admin::roles.create',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:15.351',	'2025-05-13 17:04:15.351',	NULL,	NULL),
(86,	'admin::roles.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:15.552',	'2025-05-13 17:04:15.552',	NULL,	NULL),
(87,	'admin::roles.update',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:15.751',	'2025-05-13 17:04:15.751',	NULL,	NULL),
(88,	'admin::roles.delete',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:15.951',	'2025-05-13 17:04:15.951',	NULL,	NULL),
(89,	'admin::api-tokens.access',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:16.162',	'2025-05-13 17:04:16.162',	NULL,	NULL),
(92,	'admin::api-tokens.update',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:16.761',	'2025-05-13 17:04:16.761',	NULL,	NULL),
(93,	'admin::api-tokens.regenerate',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:16.961',	'2025-05-13 17:04:16.961',	NULL,	NULL),
(94,	'admin::api-tokens.delete',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:17.162',	'2025-05-13 17:04:17.162',	NULL,	NULL),
(95,	'admin::project-settings.update',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:17.361',	'2025-05-13 17:04:17.361',	NULL,	NULL),
(96,	'admin::project-settings.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:17.561',	'2025-05-13 17:04:17.561',	NULL,	NULL),
(97,	'admin::transfer.tokens.access',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:17.761',	'2025-05-13 17:04:17.761',	NULL,	NULL),
(98,	'admin::transfer.tokens.create',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:17.961',	'2025-05-13 17:04:17.961',	NULL,	NULL),
(99,	'admin::transfer.tokens.read',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:18.171',	'2025-05-13 17:04:18.171',	NULL,	NULL),
(100,	'admin::transfer.tokens.update',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:18.371',	'2025-05-13 17:04:18.371',	NULL,	NULL),
(101,	'admin::transfer.tokens.regenerate',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:18.571',	'2025-05-13 17:04:18.571',	NULL,	NULL),
(102,	'admin::transfer.tokens.delete',	'{}',	NULL,	'{}',	'[]',	'2025-05-13 17:04:18.771',	'2025-05-13 17:04:18.771',	NULL,	NULL),
(103,	'plugin::content-manager.explorer.create',	'{}',	'api::page.page',	'{"fields": ["slug", "Nom", "pageBackgroundColor", "showMenu", "showFooter", "ellipses.color", "ellipses.enableRightPosition", "ellipses.xPosition", "ellipses.yPosition"]}',	'[]',	'2025-05-13 17:05:54.641',	'2025-05-13 17:05:54.641',	NULL,	NULL),
(104,	'plugin::content-manager.explorer.read',	'{}',	'api::page.page',	'{"fields": ["slug", "Nom", "pageBackgroundColor", "showMenu", "showFooter", "ellipses.color", "ellipses.enableRightPosition", "ellipses.xPosition", "ellipses.yPosition"]}',	'[]',	'2025-05-13 17:05:54.838',	'2025-05-13 17:05:54.838',	NULL,	NULL),
(105,	'plugin::content-manager.explorer.update',	'{}',	'api::page.page',	'{"fields": ["slug", "Nom", "pageBackgroundColor", "showMenu", "showFooter", "ellipses.color", "ellipses.enableRightPosition", "ellipses.xPosition", "ellipses.yPosition"]}',	'[]',	'2025-05-13 17:05:55.038',	'2025-05-13 17:05:55.038',	NULL,	NULL);
...
(2,	'#ffffff',	12,	'Nos offres d’emplois',	'#ffffff',	'#F28705',	'#ffffff',	'#F28705',	'#ffffff',	'#1E2634');
...
INSERT INTO "components_c4d_components_carousel_slide_job_offers_components" ("id", "entity_id", "component_id", "component_type", "field", "order") VALUES
(9,	2,	2,	'c4d-components.job-offer',	'cards',	1),
(12,	2,	3,	'c4d-components.job-offer',	'cards',	2),
(13,	2,	4,	'c4d-components.job-offer',	'cards',	3),
(23,	2,	6,	'c4d-components.job-offer',	'cards',	4);
...
INSERT INTO "components_c4d_components_job_offers" ("id", "title", "required_education_level", "work_type", "contract_type", "job_description", "link", "card_spacing") VALUES
(3,	'Back-End Developer',	'Bac+2',	'Hybride',	'CDI',	'Participe à la mise en place de microservices évolutifs. Idéal pour un profil motivé avec de bonnes bases en Node.js et une envie d''apprendre au quotidien.',	'https://fr.linkedin.com/company/cloud4dev',	'0'),
(4,	'Back-End Developer',	'Bac+5',	'Hybride',	'CDI',	'Tu interviendras sur l’architecture globale de notre plateforme. Environnement stimulant, stack moderne, et challenge technique garanti.',	'https://fr.linkedin.com/company/cloud4dev',	'0'),
(2,	'Back-End Developer',	'Bac+3',	'Hybride',	'CDI',	'Rejoins une équipe dynamique pour concevoir des APIs performantes et sécurisées. Tu travailleras sur des projets innovants en étroite collaboration avec les équipes front-end',	'https://fr.linkedin.com/company/cloud4dev',	'0'),
(6,	'Devops',	'bac+5',	'Full Télétravail',	'CDI',	'Participe à la mise en place de microservices évolutifs. Idéal pour un profil motivé avec de bonnes bases en Node.js et une envie d''apprendre au quotidien.',	'https://fr.linkedin.com/company/cloud4dev',	NULL);
...
(1578,	31,	4,	'c4d-components.carousel-type-linear',	'image',	1),
...
(1,	'2024-06-11 17:07:38.827',	'2025-05-13 18:03:02.67',	'2024-06-11 17:14:10.603',	1,	1);
...
(145,	1,	13,	'c4d-components.vertical-space',	'dz',	1),
(146,	1,	4,	'c4d-components.carousel-type-linear',	'dz',	2),
(147,	1,	16,	'c4d-components.vertical-space',	'dz',	3),
(148,	1,	2,	'c4d-components.carousel-slide-job-offers',	'dz',	4),
(149,	1,	15,	'c4d-components.vertical-space',	'dz',	5),
(150,	1,	4,	'c4d-components.spontaneous-job-application-form',	'dz',	6);
...
(16,	'amin.eddine31@icloud.com',	'2025-05-13 17:59:29.992',	'2025-05-13 17:59:29.992',	'2025-05-13 17:59:29.991',	NULL,	NULL);
